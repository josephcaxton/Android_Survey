...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/uk.co.bbc.survey/databases/";
 
    private static String DB_NAME = "SurveyLocal.sqlite";
  ...
  private final Context myContext;
    ...
    private boolean checkDataBase(){
    	...
    	try{
    		...
    		Log.d("Joseph",e.getMessage().toString());
...
public static void backupDatabase() throws IOException {
    //Open your local db as the input stream
    String inFileName = "/data/data/uk.co.bbc.survey/databases/TempDB.sqlite";
